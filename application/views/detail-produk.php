...
<body>
	...
	<div class="section">
		<div class="container">
			...
			<div class="box">
				<div class="col-2">
					<img src="<?php echo base_url('assets/') ?>produk/<?php echo $p->product_image ?>" width="100%">
				</div>
				<div class="col-2">
					...
					<p><a href="https://api.whatsapp.com/send?phone=<?php echo $a->admin_telp ?>&text=Hai, saya tertarik dengan produk Anda." target="_blank">
						...
						<img src="<?php echo base_url('assets/') ?>produk/wa.png" width="50px"></a>
					</p>
				</div>
			</div>
		</div>
